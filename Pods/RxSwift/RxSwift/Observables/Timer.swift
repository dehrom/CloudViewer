...
fileprivate final class TimerSink<O: ObserverType>: Sink<O> where O.E: RxAbstractInteger {
...
fileprivate final class TimerOneOffSink<O: ObserverType>: Sink<O> where O.E: RxAbstractInteger {
    typealias Parent = Timer<O.E>
...
fileprivate final class Timer<E: RxAbstractInteger>: Producer<E> {
