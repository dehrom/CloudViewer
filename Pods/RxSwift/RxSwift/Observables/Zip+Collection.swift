...
fileprivate final class ZipCollectionTypeSink<C: Collection, O: ObserverType>
...
fileprivate final class ZipCollectionType<C: Collection, R>: Producer<R> where C.Iterator.Element: ObservableConvertibleType {
