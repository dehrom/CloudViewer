...
fileprivate final class CombineLatestCollectionTypeSink<C: Collection, O: ObserverType>
...
fileprivate final class CombineLatestCollectionType<C: Collection, R>: Producer<R> where C.Iterator.Element: ObservableConvertibleType {
    ...
    init(sources: C, resultSelector: @escaping ResultSelector) {
        ...
        _count = Int(Int64(_sources.count))
    }
